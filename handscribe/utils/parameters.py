...
def get_parser():
    ...
    parser.add_argument(
        ...
        type=str2bool,
        default=True,
        help='whether to use gloss free training or not')

    # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
    # processor
    parser.add_argument('--phase', default='train', help='can be train, test and features')
    ...
    parser.add_argument(
        '--lang',
        default='German',
        help='MBART language name (key from get_mbart_langs_dict), e.g. German, English.'
            'This can be used as --lang to set mbart source/target language when loading MBART.')
    # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
    # decoder
    parser.add_argument('--decoder', default=None, help='the decoder will be used')
    parser.add_argument(
        '--decoder-args',
        nargs='*',
        action=ParseKwargs,
        default=dict(),
        help='the arguments of decoder')
    parser.add_argument(
        '--projector-type',
        default='GFProjectionLayer',
        help='the projection type for the decoder (e.g., GFResidualProjectionLayer, GFProjectionLayer)'
    )
    # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
    # optim
    parser.add_argument(
